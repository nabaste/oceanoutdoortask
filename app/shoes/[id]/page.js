...
export default function ProductDetailPage({ params }) {
    ...
    useEffect(() => {
        ...
        const handleScroll = () => {
            ...
            // Only show sticky button on mobile
            const isMobile = window.innerWidth < 1024;
            setShowStickyButton(!isVisible && isMobile);
    ...
    return (
        <div className="min-h-screen bg-white pb-20">
                ...
                <div className="lg:grid lg:grid-cols-2 lg:gap-x-8 lg:items-start">
                    ...
                    <div className="mt-8 lg:mt-0">
                        <div className="flex items-baseline justify-between">
                            <h1 className="text-4xl lg:text-5xl font-agdasima font-bold text-gray-900">{prod.name}</h1>
                            <p className="text-3xl lg:text-4xl font-light font-agdasima text-gray-900">{prod.price}</p>
                        </div>
                        <p className="mt-4 font-lora text-gray-900 lg:text-lg">{prod.description}</p>
                        ...
                        {/* Bottom Buttons - Desktop Version */}
                        <div id="bottom-buttons" className="flex gap-4 mt-8">
                            <button
                                className="flex-1 bg-black font-agdasima text-4xl font-light text-white py-3 px-4 rounded-sm hover:bg-gray-800 transition-colors duration-200"
                        ...
                        {/* Accordion Sections */}
                        <div
                            className="border-y divide-y border-pink-600 divide-pink-600 font-workSans text-black mt-8">
            ...
            {showStickyButton && (
                <div
                    className="fixed bottom-0 left-0 right-0 bg-black py-2 font-agdasima text-3xl transition-all duration-300 lg:hidden">
                    <button
